...
@interface ResultOverViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation ResultOverViewController
...
- (void)viewDidLoad {
    ...
    ////
    self.m_quiz_result_arr = g_GameSet.g_quiz_result_Arr;
...
- (IBAction)onSubmitBtn:(id)sender {
    ...
    /////////////Initializing Spin information
    [g_GameSet.g_curSpinCategory_Arr removeAllObjects];
    g_GameSet.g_curSpinCategory_Arr = nil;
    g_GameSet.g_curSpinCategory_Arr = [[NSMutableArray alloc] initWithObjects:[NSNumber numberWithInt:CTGY_SCIENCE],
    ...
    [g_GameSet.g_remainCategory removeAllObjects];
    g_GameSet.g_remainCategory = nil;
    g_GameSet.g_remainCategory = [[NSMutableArray alloc] initWithObjects:[NSNumber numberWithInt:CTGY_SCIENCE],
                                       [NSNumber numberWithInt:CTGY_ELECTIVES],
                                       [NSNumber numberWithInt:CTGY_ENGLISH],
                                       [NSNumber numberWithInt:CTGY_HISTORY],
                                       [NSNumber numberWithInt:CTGY_MATH],
    ...
    g_GameSet.g_elimate_category_type = CTGY_NONE;
    
    [g_GameSet.g_quiz_result_Arr removeAllObjects];
